...
describe("MelonlyClient", () => {
  ...
  describe("Constructor", () => {
    ...
    it("should throw ValidationError for undefined token", () => {
      ...
      expect(
        () => new MelonlyClient({ token: undefined as unknown as string }),
  ...
  describe("Applications", () => {
    ...
    it("should validate pagination parameters", async () => {
      await expect(client.getApplications({ page: 0 })).rejects.toThrow(
        ValidationError,
      );
      await expect(client.getApplications({ page: -1 })).rejects.toThrow(
        ValidationError,
      );
      await expect(client.getApplications({ limit: 0 })).rejects.toThrow(
        ValidationError,
      );
      await expect(client.getApplications({ limit: 101 })).rejects.toThrow(
        ValidationError,
      );
    });
    ...
    it("should validate application ID", async () => {
      ...
      await expect(client.getApplication("  ")).rejects.toThrow(
        ValidationError,
      );
  ...
  describe("Error Handling", () => {
    ...
    it("should handle network timeouts", async () => {
      ...
      await expect(shortTimeoutClient.getServerInfo()).rejects.toThrow(
        TypeError,
      );
    });
